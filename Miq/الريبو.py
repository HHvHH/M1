...
async def restart(client, m: Message):
    ...
    await loli.edit("8")
    await loli.edit("9")
    await loli.edit("**✅ تم اعاده تشغيل بوت الاغاني**")
    os.execl(sys.executable, sys.executable, *sys.argv)
    quit()
@Client.on_message(filters.user(SUDO_USERS) & filters.command(["الاوامر","اوامر الاغاني"], prefixes=f"{HNDLR}"))
@authorized_users_only
...
———————×———————
 مطور بوت الاغاني : @HvvHH
قناة بوت الاغاني:  @deoou"""
    await m.reply(HELP)
